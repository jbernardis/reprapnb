...
from settings import BUTTONDIM, MAX_EXTRUDERS, kOverride, SAVE_SETTINGS_FILE
...
class Slic3r:
	...
	def mergeProfiles(self, overrides):
		...
		for k in overrides.keys():
			if k == 'layerheight':
				dProfile['layer_height'] = overrides[k]
